...
exports.heartbeat = jsonEndpoint('GET',async (req) => {
  if (req.query.database===undefined || req.query.database==='true' || req.query.database===true) {
    await getData('Nonexistant','1')
  }
  return {
    success: true
  };
